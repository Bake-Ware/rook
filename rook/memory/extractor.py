...
- "fact": A COMPLETE, self-contained statement. Include ALL context needed to understand it later without any conversation history. Bad: "the server". Good: "the user's primary workstation is named 'orion' (Ubuntu 24.04), reachable on the LAN as orion.local"
