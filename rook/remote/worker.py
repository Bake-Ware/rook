...
Bootstrap:
  Windows (PowerShell):
    iex (irm https://hub.example.com/worker)
  Linux/Mac:
    curl -sL https://hub.example.com/worker | python3 -

Manual:
    python worker.py --name mypc --server wss://hub.example.com/ws --token SECRET
"""
...
def main():
    ...
    parser.add_argument("--server", default="wss://hub.example.com/ws", help="Rook WebSocket URL")
