...
class RookBridge:
    ...
    def __init__(
        ...
        host = host or os.environ.get("ROOK_BRIDGE_HOST", "192.168.4.1")
        admin_user = admin_user or os.environ.get("ROOK_ADMIN_USER", "admin")
        admin_pass = admin_pass or os.environ.get("ROOK_ADMIN_PASS", "")
